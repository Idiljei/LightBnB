 ...
 */
  ...
  const addProperty = function(property) {
    ...
    return pool.query(
      ...
      `
      , [property.title, property.description,property.number_of_bedroom, property.number_of_bathrooms,
        property.parking_spaces, property.cost_per_night,property.thumbnail_photo_url, property.cover_photo_url,
    property.street, property.country, property.city, property.province, property.post_code, property.owner_id ]
  ).then(res => res.rows[0]);
